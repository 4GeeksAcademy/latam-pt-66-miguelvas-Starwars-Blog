		...
		<nav className="navbar navbar-dark bg-dark">
			<div className="container d-flex align-items-center justify-content-between">
				<Link to="/" className="d-flex align-items-center text-decoration-none">
					...
					<span className="navbar-brand mb-0 h1 text-decoration-none fs-3" style={{fontFamily: 'StarJedi'}}>Starwars Blog</span>
				</Link>
				<div className="ml-auto">
					<Link to="/demo">
						<div className="dropdown">
							<button className="btn btn-outline-light dropdown-toggle text-light" type="button" data-bs-toggle="dropdown">
								Favorites
							</button>
